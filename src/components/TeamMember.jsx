...
export default function TeamMember({ name, role, image, description }) {
    return (
        <div className="flex flex-col items-center max-w-96 p-4 rounded-xl bg-gray-100/10 border-gray-50/20 border-1 transition-transform hover:scale-105 shadow-md">
