    ...
    <>
        ...
        <div className="flex flex-col items-center my-6">
            <a href="#" className="logo">
                <img src={ robotLogo } className="h-48 p-1 rounded-full will-change-[filter] transition-[filter] duration-200 hover:drop-shadow-[0_0_2em_#503cff66]" id="roboticsLogo" alt="CHS Robotics Logo" />
            </a>
            <h1 className="text-8xl max-lg:text-6xl font-extrabold my-4 text-transparent max-lg:text-white bg-gradient-to-r from-blue-50 from-20% to-blue-400 bg-clip-text bg-size-[300%_auto] bg-position-[0%] hover:bg-position-[60%] transition-all duration-300">CHS ROBOTICS CLUB</h1>
            <h2 className="text-3xl tracking-wider font-medium">Innovate. Build. Compete. Inspire. Idk.</h2>
        </div>
        ...
        <div className="section flex justify-around max-w-full">
            ...
            <div id="ig-embed" className="side m-8 max-w-1/3 max-h-full hover:rotate-1">
                <iframe className="rounded-2xl h-full" src="https://www.instagram.com/cchavezroboticsclub/embed/?cr=1&v=14&rd=http%3A%2F%2Flocalhost%3A5173&rp=%2Frobotics-website%2F#%7B%22ci%22%3A0%2C%22os%22%3A107.90000000596046%2C%22ls%22%3A14.5%2C%22le%22%3A73.09999999403954%7D" frameborder="0"></iframe>
            </div>
        </div>

        <div className="section flex justify-around">
            <div className="side m-8 max-w-1/3 self-center hover:-rotate-1">
